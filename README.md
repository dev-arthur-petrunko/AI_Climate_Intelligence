...
- 🤖 **AI Predictions** — forecasts with probability scores, confidence intervals, and risk assessments across multiple timeframes
- 📈 **Interactive Analytics** — historical trends and climate data visualization with Plotly.js
- 💬 **AI Assistant** — floating conversational chat widget with natural-language queries
...
│   │   ├── AIPredictions.tsx      # AI forecast cards
...
| `GET /api/predictions` | AI-generated climate predictions |
...
- AI predictions with risk assessments
- AI assistant chat widget
- 7-language support
- FastAPI backend with 19 endpoints and graceful fallbacks
